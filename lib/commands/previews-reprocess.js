...
module.exports = {
    ...
    'invoke': function(session, args, callback) {
        ...
        if (!_.isEmpty(argv._) && (argv.content || argv.revision)) {
            ...
            // not both
            throw new ValidationError('filter', 'If the content ID and revision ID are provided, the filters should not be provided.', _help());
            ...
            throw new ValidationError('content and revision id', 'If specifying a particular revision, both content and revision ID should be specified', _help());
        }
...
function _help() {
    return 'Usage: previews-reprocess [<content id> <revision id>] | [--<filter key>=<filter value> ...]\n\n' +
